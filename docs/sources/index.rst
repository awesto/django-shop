...
The **django-SHOP** framework is, as its name implies, a framework and not a program which runs
...
The Physical Representation of a Product corresponds to its logical
-------------------------------------------------------------------
