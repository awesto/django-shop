...
Django application ``email_auth`` would lock them out: Guests would be allowed to buy once, and
as soon as they try to purchase a second time, they would require another email address – this is
