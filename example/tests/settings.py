...
"""
Settings for Unit-Testing django-SHOP
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(WORK_DIR, 'testdb.sqlite3'),
    }
}
...
SHOP_PRODUCT_SUMMARY_SERIALIZER = 'tests.serializers.ProductSummarySerializer'
SHOP_CART_MODIFIERS = [
