# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-04-26 19:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.TextField(blank=True, help_text="Caption used in the catalog's list view of products.", null=True, verbose_name='Caption')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('description', models.TextField(help_text="Full description used in the catalog's detail view of Smart Cards.", verbose_name='Description')),
            ],
            options={
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('description', models.TextField(help_text="Full description used in the catalog's detail view of Smart Phones.", verbose_name='Description')),
            ],
            options={
                'managed': True,
        ...
        migrations.AddField(
            model_name='product',
            name='sample_image',
            field=filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sample_image', to='filer.Image'),
        ),
        migrations.AddField(
