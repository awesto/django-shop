# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-13 12:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(shop.models.defaults.commodity.CMSPageReferenceMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('confirm_payment', 'Can confirm a payment'),),
            },
        ...
        migrations.AddField(
            model_name='commodity',
            name='sample_image',
            field=filer.fields.image.FilerImageField(help_text="Sample image used in the catalog's list view.", on_delete=django.db.models.deletion.CASCADE, to='filer.Image', verbose_name='Sample Image'),
        ),
        migrations.AddField(
            model_name='cartitem',
            name='product',
