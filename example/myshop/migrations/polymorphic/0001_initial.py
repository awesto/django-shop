    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', djangocms_text_ckeditor.fields.HTMLField(help_text='Short description for the list view of products.', verbose_name='Caption')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('description', djangocms_text_ckeditor.fields.HTMLField(help_text='Full description for the detail view of Smart Cards.', verbose_name='Description')),
            ],
            options={
                'managed': True,
