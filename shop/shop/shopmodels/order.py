...
# import shop.models.defaults.order
...
# from shop.shopmodels.defaults.order import OrderItem, Order
...
# class WorkflowMixinMetaclass(models.Model):
    """
...
# class BaseOrder(models.Model):
    ...
    """
    __metaclass__ = WorkflowMixinMetaclass
    TRANSITION_TARGETS = {
