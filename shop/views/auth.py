...
class AuthFormsView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        if request.customer.is_visitor:
            ...
            customer = BaseCustomer.objects.get_or_create_from_request(request)
        else:
...
class LoginView(OriginalLoginView):
    ...
    def login(self):
        ...
        try:
            ...
            anonymous_cart = BaseCart.objects.get_from_request(self.request)
        ...
        authenticated_cart = BaseCart.objects.get_from_request(self.request)
        if anonymous_cart:
