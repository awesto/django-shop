...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItem.product_reference'
        db.delete_column('shop_orderitem', 'product_reference')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OrderItem.product_reference'
        db.add_column('shop_orderitem', 'product_reference', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
