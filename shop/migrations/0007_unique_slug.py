...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product']))

        # Changing field 'OrderItem.product'
        db.alter_column('shop_orderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CartItem.product'
        db.alter_column('shop_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product']))
    ...
    models = {
        ...
        'product.badge': {
            ...
            'link': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'tooltip': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'product.product': {
            'Meta': {'object_name': 'Product', '_ormbases': ['configurableproduct.CProduct']},
            'badges': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['product.Badge']", 'symmetrical': 'False', 'blank': 'True'}),
            'cproduct_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['configurableproduct.CProduct']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'extra_price1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'extra_price2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'extra_price3': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'extra_price4': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'extra_price5': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'old_price': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'related_category': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['shop_simplecategories.Category']", 'null': 'True', 'blank': 'True'}),
            'related_products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_to'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['product.Product']"}),
            'seo_text': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.SeoTexts']", 'null': 'True', 'blank': 'True'}),
            'service': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'product.seotexts': {
            'Meta': {'object_name': 'SeoTexts'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'shop_simplecategories.category': {
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'categories'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['product.Product']"}),
