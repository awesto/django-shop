...
class MoneyMaker(type):
    ...
    def __unicode__(self):
        ...
        """
        try:
            amount = number_format(self._dec.quantize(self._cents))
    ...
    def __sub__(self, other, context=None):
        self._assert_addable(other)
        amount = self._dec.__sub__(other._dec, context)
        return self.__class__(amount)
    ...
    def __mul__(self, other, context=None):
        ...
        amount = self._dec.__mul__(other, context)
        return self.__class__(amount)
    ...
    def __div__(self, other, context=None):
        ...
        amount = self._dec.__div__(other, context)
        return self.__class__(amount)
    ...
    def __truediv__(self, other, context=None):
        self._assert_dividable(other)
        amount = self._dec.__truediv__(other, context)
        return self.__class__(amount)
    ...
    def __new__(cls, currency_code=None):
        ...
        def my_new(cls, value='0', context=None):
            ...
            if isinstance(value, Decimal):
                ...
                try:
                    self._dec = Decimal(value, context)
        ...
        attrs.update(_currency_code=currency_code, _currency=CURRENCIES[currency_code],
